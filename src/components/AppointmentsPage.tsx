...
import { ChevronLeft, ChevronRight, Plus, Video, Phone, MapPin, MoreVertical, Calendar } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          >
            {showTodayOnly ? "Show All Appointments" : "Show Today Only"}
          </button>
      ...
      <Card className="border-slate-200 rounded-2xl">
        <CardHeader>
          <CardTitle>Today's Appointments ({new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })})</CardTitle>
        </CardHeader>
